    ...
    <footer className="w-full border-t border-border mt-auto bg-muted/30">
      <div className="container max-w-screen-xl mx-auto px-4 md:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-16">
          ...
          {/* Navigation */}
          <div>
            <h3 className="text-sm font-semibold mb-4">{t("navigation")}</h3>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <a
                ...
                className="text-sm text-muted-foreground transition-colors hover:text-foreground inline-flex items-center gap-2"
              >
